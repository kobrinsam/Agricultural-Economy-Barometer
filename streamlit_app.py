...
st.subheader("Providing a sense of the health of the agriculture industry on a monthly basis")
...
####
# correlations df
corr_df = scaled_df.rename(columns={"DC=F":"Milk Futures (DC-F)", "HE=F" :"Lean Hog Futures (HE=F)",
                              "LE=F": "Live Cattle Futures (LE=F)",
                              "UFV=F":"Urea (Granular) FOB US Gulf Fut (UFV=F)",
                              "ZS=F":"Soybean Futures,Nov-2022 (ZS=F)",
                              "NG=F": "Natural Gas Oct 22 (NG=F)",
                              "ZC=F":"Corn Futures,Dec-2022 (ZC=F)"}).corr()
###functions
